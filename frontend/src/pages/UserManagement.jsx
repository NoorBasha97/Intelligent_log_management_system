...
import { UserPlus, Trash2, X, Loader2, CheckCircle2, AlertCircle, Edit2 } from 'lucide-react';
            ...
            {users.map(u => (
              <tr key={u.user_id} className="hover:bg-slate-50/50 transition">
                ...
                <td className="p-4 flex justify-center gap-2">
                  ...
                  <button
                    onClick={() => handleEditClick(u)} // Pass the whole user object
              ...
              <form onSubmit={handleAddUser} className="p-6 space-y-4">
                ...
                <div className="pt-4 flex gap-3">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="flex-1 bg-indigo-600 text-white px-4 py-2 rounded-lg hover:bg-indigo-700 transition font-semibold flex items-center justify-center gap-2"
                  >
